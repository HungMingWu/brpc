...
private:
    ...
    std::atomic<TaskNode*> BAIDU_CACHELINE_ALIGNMENT _head;
    std::atomic<uint64_t> BAIDU_CACHELINE_ALIGNMENT _versioned_ref;
    std::atomic<bool> BAIDU_CACHELINE_ALIGNMENT _stopped;
